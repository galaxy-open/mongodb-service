...
const primaryHex = '#6C4CFC'
const primaryColors: MantineColorsTuple = [
  lighten(primaryHex, 0.6),
  lighten(primaryHex, 0.5),
  lighten(primaryHex, 0.4),
  lighten(primaryHex, 0.3),
  lighten(primaryHex, 0.2),
  lighten(primaryHex, 0.1),
  primaryHex,
  darken(primaryHex, 0.1),
  darken(primaryHex, 0.2),
  darken(primaryHex, 0.3),
  darken(primaryHex, 0.4),
]
