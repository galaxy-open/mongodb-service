...
@inject()
export default class MongoDBReplicaSetConfig extends BaseDatabaseConfig {
  constructor(
  ...
  buildTemplateData(params: DatabaseGenerationParams): TemplateData {
    ...
    const replicaKeySecretName = this.replicaKeyService.buildReplicaKeySecretName(params.stackName!)
    ...
    return {
      ...
      workerNodes: params.databaseWorkerNodes,
    }
  }

  getTemplatePath(): string {
    return 'docker-compose/mongodb/replicaset'
  }
}
